 ...
 const fetchThumbnail = async () => {
  try {
    ...
    if (thumb) {
      ...
      // Use empty strings as fallbacks to prevent "undefined" errors
              ...
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                ...
                <div className="space-y-5">
                  ...
                  <div>
                    ...
                    focus:outline-zone focus:ring-2 focus:ring-pink-500"
                    />
                  ...
                  {/* CollorScheme SELECTOR */}

                  <ColorSchemeSelector value={String(colorSchemeId)} onChange={setColorSchemeId}/>  
                  ...
                  <div className="space-y-2">
                    ...
                    placeholder="Add any spesific elements ,mood or style pereference.."
                ...
                {!id && (
                  ...
                  onClick={handleGenerate}
                    className="text-[15px] w-full py-3.5 
                  rounded-xl font-medium bg-linear-to-b from-pink-500 to-pink-600 hover:from-pink-700  
