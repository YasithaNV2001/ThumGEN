...
const PreviewPanel = ({
  ...
  return (
    <div className="relative mx-auto w-full max-w-2xl">
      <div className={`relative overflow-hidden rounded-xl bg-black/50 ${aspectClasses[aspectRatio]}`}>
        {/* Loading State */}
